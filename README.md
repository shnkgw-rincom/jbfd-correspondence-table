...
This is Version 0.1. Individual matches may contain errors. Users are encouraged to verify entries and report discrepancies via GitHub Issues.
...
•	Known issues and corrections are tracked in GitHub Issues
...
License
The correspondence table is released under CC BY 4.0. You are free to share and adapt the data for any purpose, provided appropriate credit is given.
